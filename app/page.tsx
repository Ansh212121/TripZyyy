        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-8 flex flex-col items-center text-center bg-[#16213a] text-white">
              ...
              <p className="mb-6 text-lg text-white">“I saved so much on travel and met amazing people. The booking process is seamless!”</p>
              <span className="font-bold text-blue-400">Priya S.</span>
              <span className="text-white">Student, Delhi</span>
            </Card>
            <Card className="p-8 flex flex-col items-center text-center bg-[#16213a] text-white">
              <div className="mb-4">
                <Quote className="mx-auto h-10 w-10 text-green-400" />
              </div>
              <p className="mb-6 text-lg text-white">“As a driver, I love filling my empty seats and covering fuel costs. Highly recommend!”</p>
              <span className="font-bold text-green-400">Rahul M.</span>
              <span className="text-white">Engineer, Mumbai</span>
            </Card>
            <Card className="p-8 flex flex-col items-center text-center bg-[#16213a] text-white">
              <div className="mb-4">
                <Quote className="mx-auto h-10 w-10 text-orange-400" />
              </div>
              <p className="mb-6 text-lg text-white">“It feels good to help the environment while traveling. The app is super easy to use.”</p>
